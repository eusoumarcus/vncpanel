...
class ImpressoraControllerSpec extends Specification implements ControllerUnitTest<ImpressoraController>, DomainUnitTest<Impressora> {
    ...
    void "Test the index action returns the correct model"() {
        ...
        !model.impressoraList
        model.impressoraCount == 0
    }
    ...
    void "Test the save action with a null instance"() {
        ...
        response.redirectedUrl == '/impressora/index'
        flash.message != null
    }
    ...
    void "Test the save action correctly persists"() {
        ...
        response.redirectedUrl == '/impressora/show/1'
    ...
    void "Test the show action with a valid id"() {
        ...
        model.impressora instanceof Impressora
    }
    ...
    void "Test the update action with an invalid instance"() {
        ...
        request.contentType = FORM_CONTENT_TYPE
        request.method = 'PUT'
        controller.update(new Impressora())
